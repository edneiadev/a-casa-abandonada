...
const levels = [
  {
    ...
    name: "Nível 1",
    difficulty: "Fácil",
    clue: "Uma das letras da senha é a 3ª letra da palavra FOGO.",
    questions: [
      {
        statement: "O número 34 tem 3 dezenas e 4 unidades.",
        answer: true,
      },
      {
        statement: "O número 50 tem 50 dezenas.",
        answer: false,
      },
      {
        statement: "O número 18 tem 18 dezenas.",
        answer: false,
      },
      {
        statement: "2 dezenas são iguais a 20.",
        answer: true,
      },
      {
        statement: "O número 50 é menor do que 49.",
        answer: false,
      },
    ],
  },
  {
    ...
    name: "Nível 2",
    difficulty: "Médio",
    clue: "Uma das letras da senha é a 1ª letra do alfabeto.",
    questions: [
      {
        statement: "1 dezena é igual a 100",
        answer: false,
      },
      {
        statement: "O número 72 tem 7 dezenas e 2 unidades.",
        answer: true,
      },
      {
        statement: "O número 60 tem 6 unidades.",
        answer: false,
      },
      {
        statement: "3 dezenas e 5 unidades formam o número 35.",
        answer: true,
      },
      {
  ...
  },
  {
    ...
    clue: "É O NOME DE UM ANIMAL.",
    questions: [
      {
        statement: "O número 16 tem 6 dezenas e 1 unidade.",
        answer: false,
      },
      {
        statement: "O número 27 tem 7 dezenas e 2 unidades.",
        answer: false,
      },
      {
        statement: "9 dezenas são iguais a 90.",
        answer: true,
      },
      {
      ...
      {
        statement: "O número 15 tem 5 dezenas e 1 unidade.",
        answer: false,
      },
    ],
  },
...
function renderFinalChallenge() {
  ...
  document.getElementById("check-password").addEventListener("click", () => {
    ...
    state.finalStatus = password === "GATO" ? "victory" : "defeat";
