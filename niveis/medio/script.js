...
const levels = [
  {
    ...
    name: "Nível 1",
    difficulty: "Fácil",
    clue: "A senha começa com a 1ª letra do alfabeto.",
    questions: [
      {
        statement: "O número 134 tem 1 centena, 3 dezenas e 4 unidades.",
        answer: true,
      },
      {
        statement: "O número 200 tem 2 dezenas.",
        answer: false,
      },
      {
        statement: "5 dezenas são iguais a 500.",
        answer: false,
      },
      {
        statement: "1 centena é igual a 100.",
        answer: true,
      },
      {
        statement: "4 centenas são iguais a 40.",
        answer: false,
      },
    ],
  },
  {
    ...
    name: "Nível 2",
    difficulty: "Médio",
    clue: "A 2ª letra da senha é a última letra da palavra VOZ.",
    questions: [
      {
        statement: "O número 250 tem 2 centenas e 5 unidades.",
        answer: false,
      },
      {
        statement: "O número 120 tem 1 centena, 2 dezenas e 0 unidades.",
        answer: true,
      },
      {
        statement: "7 centenas são iguais a 70.",
        answer: false,
      },
      {
        statement: "3 centenas são iguais a 300.",
        answer: true,
      },
      {
        statement: "7 dezenas são iguais a 70.",
        answer: true,
      },
    ],
  },
  {
    ...
    clue: "As duas últimas letras da senha são as mesmas duas últimas letras da palavra SUL.",
    questions: [
      {
        statement: "O número 321 tem 3 dezenas, 2 centenas e 1 unidade.",
        answer: false,
      },
      {
        statement: "O número 105 tem 1 centena e 5 dezenas.",
        answer: false,
      },
      {
        statement: "O número 480 tem 4 centenas, 8 dezenas e 0 unidades.",
        answer: true,
      },
      {
        statement: "1 dezena e 2 unidades formam o número 12.",
        answer: true,
      },
      {
        statement: "O número 300 tem 3 dezenas.",
        answer: false,
      },
    ],
  },
...
function updateInstallButton() {
  if (state.isInstalled) {
    installButton.textContent = "Jogo instalado";
  ...
  installButton.textContent = state.installPrompt ? "Instalar jogo" : "Como instalar";
}
...
function showInstallInstructions() {
  ...
  const message = isIOS
    ? "Para instalar no iPhone ou iPad, toque em Compartilhar e depois em Adicionar à Tela de Início."
    : "Se o botão de instalação não aparecer automaticamente, abra o menu do navegador e escolha Instalar aplicativo ou Adicionar à tela inicial.";
...
function renderFinalChallenge() {
  ...
  app.innerHTML = `
    <section class="screen final-screen">
      <div class="panel final-copy">
        ...
        <p class="password-help">Use as pistas conquistadas nos níveis para descobrir a palavra secreta. Ela é o nome de uma cor.</p>
  ...
  document.getElementById("check-password").addEventListener("click", () => {
    ...
    state.finalStatus = password === "AZUL" ? "victory" : "defeat";
